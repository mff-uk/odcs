...
public class ConfigDialog extends CustomComponent {
	...
	private TextArea textAreaConstr; //SPARQLConstruct
	...
	public Configuration getConfiguration() { 
		...
		config.setValue(Config.SPARQLConstruct.name(), textAreaConstr.getValue());
		*/
		return config;
	}
	...
	public void setConfiguration(Configuration conf) {
		...
		try
		{
			...
			//textAreaConstr.setValue( (String) conf.getValue(Config.SPARQLConstruct.name()));
