...
public class MyRDFHandler implements RDFHandler {
	 ...
	 * data format.
	 *
	 * @param writer     Instance of writer where RDF data will be written.
	 * @param formatType Specifies output RDF data format.
	 */
	 ...
	 * out RDF data format.
	 *
	 * @param os         OutputStream where RDF data will be added.
	 * @param formatType Specifies output RDF data format.
	 */
	...
	/**
	 * Return instance of {@link RDFHandler} depends on {@link RDFFormatType}
	 * used in constructor.
	 *
	 * @return instance of {@link RDFHandler} depends on {@link RDFFormatType}
	 *         used in constructor.
	...
	/**
	 * Set {@link #handler} as concrete implementation of {@link RDFWriter}
	 * depends on given {@link RDFFormatType} defined in constructor.
	 *
	 * @param os instance of outputStream for you set hander.
	 */
	 ...
	 * depends on given {@link RDFFormatType} defined in constructor.
	 *
	 * @param writer instance of writer for you set hander.
	 */
	...
	/**
	 * Call same named method {@link RDFHandler#startRDF()} on instance of
	 * {@link #handler}.
	 *
	...
	/**
	 * Call same named method {@link RDFHandler#endRDF()} on instance of
	 * {@link #handler}.
	 *
	 * @throws RDFHandlerException if handler find out problem during execution
	 *                             this method.
	 ...
	 *
	 * @param prefix String value of prefix of defined namespace
	 * @param uri    String value of namespace
	 * @throws RDFHandlerException if handler find out problem during execution
	 *                             this method.
	 */
	@Override
	 ...
	 * } on instance of {@link #handler}.
	 *
	 * @param st Statement that will be added to repository.
	 * @throws RDFHandlerException if handler find out problem during execution
	 *                             this method.
	 */
	@Override
