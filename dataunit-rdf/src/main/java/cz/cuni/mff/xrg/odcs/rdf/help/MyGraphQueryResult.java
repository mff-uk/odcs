...
public class MyGraphQueryResult implements GraphQueryResult {
	...
	/**
	 * Create new instance of {@link MyGraphQueryResult} based on interface
	 * {@link GraphQueryResult}.
	 *
	 * @param result instance of interface {@link GraphQueryResult} that will be
