...
public class PipelineGraph implements DataObject {
	 ...
	 *
	 * @param graph the value of pipeline graph.
	 */
	 ...
	 *
	 * @param node The value of node will be added to pipeline graph.
	 */
	 ...
	 *
	 * @param newNodes set of nodes for pipeline graph.
	 */
	 ...
	 *
	 * @param edges set of edges for pipeline graph.
	 */
	 ...
	 *
	 * @param edge The value of edge that will be removed.
	 ...
	 *
	 * @param pipeline the new pipeline set for this pipeline graph.
	 */
	 ...
	 * <code>String</code>s.
	 *
	 * @param fromId ID of node where the edge starts
	 * @param toId   ID of node where the edge ends
