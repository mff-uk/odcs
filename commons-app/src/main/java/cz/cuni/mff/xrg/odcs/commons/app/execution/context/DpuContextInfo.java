...
public class DpuContextInfo {
	 ...
	 * index. Does not control existence of
	 * {@link cz.cuni.mff.xrg.odcs.commons.data.DataUnit}.
	 *
	 * @param index
	 * @return
	...
	/**
	 * Return relative path from execution directory to the DPU's root 
	 * temp directory. This directory contains as subdirectories the
	 * DPU's working temp and DataUnit's temp directories.
	...
	/**
	 * Return relative path from execution directory to the DPU's temp directory.
	 ...
	 * directory. This directory can be used to store result data and
	 * it's shared by all DPU's.
	 * 
	 * @return Relative path, start but not end with separator (/, \\)
	 */
