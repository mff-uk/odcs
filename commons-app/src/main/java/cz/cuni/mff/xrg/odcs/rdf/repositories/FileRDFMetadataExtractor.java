...
public class FileRDFMetadataExtractor {
    ...
    private List<String> getMetadataValue(String subjectURI, String predicateURI) {
        ...
        throw new UnsupportedOperationException("ToDo to support if necessary");
...
//        return result;
     ...
     * @param predicates Predicates holding metadataawhich are looked up in the
     * rdf data unit
     * @return Map of all metadata values for all desired predicates of the
     * given subject URI
     */
