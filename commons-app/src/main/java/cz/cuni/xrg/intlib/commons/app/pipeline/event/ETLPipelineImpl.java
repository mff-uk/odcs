...
import cz.cuni.xrg.intlib.commons.app.pipeline.event.wrapper.*;
...
/*
import cz.cuni.xrg.intlib.commons.app.user.pipeline.event.extract.Extractor;
import cz.cuni.xrg.intlib.commons.app.user.pipeline.event.load.Loader;
import cz.cuni.xrg.intlib.commons.app.user.pipeline.event.transform.Transformer;
*/
