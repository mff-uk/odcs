...
public class DependencyGraph implements Iterable<Node> {
	...
	/**
	 * Structure for building dependency graph
	 * with dependency nodes indexed by nodes
	 */
	private Map<Node, DependencyNode> dGraph = new HashMap<Node, DependencyNode>();
	
	/**
	 * List of Extractor nodes - nodes without dependencies
	 */
	private List<DependencyNode> extractors = new ArrayList<DependencyNode>();
	...
	/**
	 * Returns iterator, which iterates over pipeline graph in a way that
	 * all dependencies come before the nodes they depend on.
	 */
	@Override
	...
	/**
	 * Finds extractors in the dependency graph.
	...
	/**
	 * Adds a dependency into dependency graph and returns it.
	 * If dependency does not exist, it is created.
	 * @param node
