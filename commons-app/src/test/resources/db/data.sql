...
-- Log messages
INSERT INTO LOGGING(timestmp, logLevel, logger, message, dpu, execution)
 VALUES(1373056400664,10000,'cz.cuni.xrg.intlib.backend.execution.PipelineWorker','Started',1,null);
INSERT INTO LOGGING(timestmp, logLevel, logger, message, dpu, execution)
 VALUES(1373056400667,10000,'org.springframework.beans.factory.support.DefaultListableBeanFactory','Returning cached instance of singleton bean "transactionManager"',1,null);
INSERT INTO LOGGING(timestmp, logLevel, logger, message, dpu, execution)
 VALUES(1373056401201,10000,'org.springframework.beans.factory.support.DefaultListableBeanFactory','Returning cached instance of singleton bean "engine"',1,1);
INSERT INTO LOGGING(timestmp, logLevel, logger, message, dpu, execution)
 VALUES(1373056400664,10000,'cz.cuni.xrg.intlib.backend.execution.PipelineWorker','Started',1,1);
INSERT INTO LOGGING(timestmp, logLevel, logger, message, dpu, execution)
 VALUES(1373056400664,10000,'cz.cuni.xrg.intlib.backend.execution.PipelineWorker','Started',1,null);
INSERT INTO LOGGING(timestmp, logLevel, logger, message, dpu, execution)
 VALUES(1373056400664,10000,'cz.cuni.xrg.intlib.backend.execution.PipelineWorker','Started',1,1);
INSERT INTO LOGGING(timestmp, logLevel, logger, message, dpu, execution)
 VALUES(1373056400664,20000,'cz.cuni.xrg.intlib.backend.execution.PipelineWorker','Started',1,1);
INSERT INTO LOGGING(timestmp, logLevel, logger, message, dpu, execution)
 VALUES(1373056400664,20000,'cz.cuni.xrg.intlib.backend.execution.PipelineWorker','Started',1,null);
INSERT INTO LOGGING(timestmp, logLevel, logger, message, dpu, execution)
 VALUES(1373056400664,20000,'cz.cuni.xrg.intlib.backend.execution.PipelineWorker','Started',1,1);
INSERT INTO LOGGING(timestmp, logLevel, logger, message, dpu, execution)
 VALUES(1373056400664,30000,'cz.cuni.xrg.intlib.backend.execution.PipelineWorker','Started',1,1);
INSERT INTO LOGGING(timestmp, logLevel, logger, message, dpu, execution)
 VALUES(1373056400664,30000,'cz.cuni.xrg.intlib.backend.execution.PipelineWorker','Started',1,null);
INSERT INTO LOGGING(timestmp, logLevel, logger, message, dpu, execution)
 VALUES(1373056400664,30000,'cz.cuni.xrg.intlib.backend.execution.PipelineWorker','Started',1,1);
