...
public final class DPUMessage extends DPUEvent {
	...
	public DPUMessage(String shortMessage, String longMessage, MessageType type, Context context, Object source) {
		super(context, source, MessageRecordType.fromMessageType(type), shortMessage, longMessage);
	}
