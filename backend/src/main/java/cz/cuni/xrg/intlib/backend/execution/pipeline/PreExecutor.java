...
/**
 * Provide action that should be perform before starts the the pipeline execution. Must not
...
public interface PreExecutor extends Ordered {
	 ...
	 * {@link PipelineEvent} with problem description.
	 * 
	 * @param execution
	 * @param graph Dependency graph used for execution.
	 * @return
	 */
	public boolean preAction(PipelineExecution execution, DependencyGraph graph);
