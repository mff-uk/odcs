...
public class LocalRDF implements RDFDataRepository {
	...
	public static LocalRDF createLocalRepoInDirectory(String dirName,
		...
		result.impl = LocalRDFRepo.createLocalRepoInTempDirectory(dirName,
				fileName);
	...
	public void addTripleToRepository(String namespace, String subjectName,
		...
		impl.addTripleToRepository(namespace, subjectName, predicateName,
				objectName);
	}
	...
	public void loadtoSPARQLEndpoint(URL endpointURL, String defaultGraphURI,
		...
		impl.loadtoSPARQLEndpoint(endpointURL, defaultGraphURI, name, password,
				graphType);
	}
	...
	public void loadtoSPARQLEndpoint(URL endpointURL,
		...
		impl.loadtoSPARQLEndpoint(endpointURL, endpointGraphsURI, userName,
				password, graphType);
	}
	...
	@Override
	public void extractfromSPARQLEndpoint(URL endpointURL,
			List<String> endpointGraphsURI, String query, String hostName,
			String password) throws ExtractException {
		impl.extractfromSPARQLEndpoint(endpointURL, endpointGraphsURI, query,
				hostName, password);
	}
	...
	public boolean isTripleInRepository(String namespace, String subjectName,
			String predicateName, String objectName) {
		return impl.isTripleInRepository(namespace, subjectName, predicateName,
				objectName);
	}
