...
public class DailyReport {
	...
	private Set<EmailAddress> getRecipients(PipelineExecution execution) {
		...
		ScheduleNotificationRecord scheduleNotification
				= execution.getSchedule().getNotification();
		...
		UserNotificationRecord userNotification
				= execution.getOwner().getNotification();
