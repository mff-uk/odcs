...
/**
 * GUI for Execution Monitor page which opens from the main menu. 
 * Contains table with pipeline execution records. Is the opportunity 
 * to open {@link DebuggingView}  from the table 
 * 
 * @author Maria Kukhar
 * @author Bogo
 */
class ExecutionMonitor extends ViewComponent implements ClickListener {
	...
	/**
	 * Builds main layout that represent as a split panel. 
	 * Right side of it contains monitor table, left side contains debugging view
	 * that shown after request only.
	 * 
	 */
	@AutoGenerated
	...
	/** 
	 *  Identify the button type was pushed (stop, showlog, debug )  
	 *  with the help of {@link ActionButtonData}.
	 *  Then produces a corresponding action. Opens {@link DebuggingView}
	 */
	@Override
	public void buttonClick(ClickEvent event) {
