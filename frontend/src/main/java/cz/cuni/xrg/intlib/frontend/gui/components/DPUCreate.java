...
public class DPUCreate extends Window {
	...
	public DPUCreate() {
		...
		GridLayout dpuGeneralSettingsLayout = new GridLayout(2, 5);
		...
		descriptionLabel.setWidth("-1px");
		descriptionLabel.setHeight("-1px");
		dpuGeneralSettingsLayout.addComponent(typeLabel, 0, 4);
		
		Label DPUType = new Label(" ");
		dpuGeneralSettingsLayout.addComponent(DPUType, 1, 4);
