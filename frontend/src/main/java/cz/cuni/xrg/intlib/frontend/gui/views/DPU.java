...
class DPU extends ViewComponent {
	...
	public DPU() {
 	...
 	/**
 	 * Layout contains basic page elements:
	...
	/**
	 * Building layout contains General tab of DPU details.
	 * @return
	 */
	...
	/**
	 * Building layout contains Instances tab of DPU details.
	 * @return
	 */
	...
	/**
	 * Building layout contains action buttons of DPU details.
	...
	/**
	 * Container with data for Instance table.
	 * @return
	 */
	...
	/**
	 * Generate column in table Instances with buttons:Detail, Delete, Status.
	 * @author Maria Kukhar
	 *
	 */
