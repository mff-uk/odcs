...
/*	@AutoGenerated
	...
	/*	// label
		...
		buttonCreateDPU.addClickListener(new com.vaadin.ui.Button.ClickListener() {
		...
		buttonImportDPU.addClickListener(new com.vaadin.ui.Button.ClickListener() {
		...
		buttonExportAll.addClickListener(new com.vaadin.ui.Button.ClickListener() {
	...
	private GridLayout buildDpuLayout() {
		...
		Tab configureTab = tabSheet.addTab(verticalLayoutConfigure, "Configure");
		...
		dpuTree.addItemClickListener(new ItemClickListener() {
			...
			public void itemClick(ItemClickEvent event) {
				// TODO Auto-generated method stub
				selectedDpu = (cz.cuni.xrg.intlib.commons.app.dpu.DPU) event.getItemId();
    ...
    //	buttonDpuBar.setSpacing(false);
		...
		buttonCopyDPU.addClickListener(new com.vaadin.ui.Button.ClickListener() {
		...
		buttonDeleteDPU.addClickListener(new com.vaadin.ui.Button.ClickListener() {
		...
		buttonExportDPU.addClickListener(new com.vaadin.ui.Button.ClickListener() {
		...
		buttonSaveDPU.addClickListener(new com.vaadin.ui.Button.ClickListener() {

			@Override
			public void buttonClick(ClickEvent event) {
				if ((selectedDpu!=null) && (selectedDpu.getId()!= 0 )){
					selectedDpu.setName(dpuName.getValue());
					selectedDpu.setDescription(dpuDescription.getValue());
					selectedDpu.setVisibility((String)groupVisibility.getValue());
		...
		buttonDpuBar.setComponentAlignment(buttonSaveDPU, Alignment.BOTTOM_RIGHT);
    ...
    private void fillTree(Tree tree) {
    	...
    	cz.cuni.xrg.intlib.commons.app.dpu.DPU rootExtractor = new cz.cuni.xrg.intlib.commons.app.dpu.DPU("Extractors", null);
		tree.addItem(rootExtractor);
		cz.cuni.xrg.intlib.commons.app.dpu.DPU rootTransformer = new cz.cuni.xrg.intlib.commons.app.dpu.DPU("Transformers", null);
		tree.addItem(rootTransformer);
		cz.cuni.xrg.intlib.commons.app.dpu.DPU rootLoader = new cz.cuni.xrg.intlib.commons.app.dpu.DPU("Loaders", null);
		tree.addItem(rootLoader);
		
		List<cz.cuni.xrg.intlib.commons.app.dpu.DPU> dpus = App.getApp().getDPUs().getAllDpus();
