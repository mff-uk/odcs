...
public class Settings extends ViewComponent {
	...
	/**
	 * Building Schedule notifications layout. Appear after pushing  Schedule notifications tab
	 * 
	 * @return notificationsLayout Layout with components of Schedule notifications.
	 */
