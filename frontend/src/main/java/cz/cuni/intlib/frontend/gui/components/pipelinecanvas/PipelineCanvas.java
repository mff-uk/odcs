...
import cz.cuni.intlib.frontend.data.pipeline.DpuInstance;
import cz.cuni.intlib.frontend.data.pipeline.Pipeline;
import cz.cuni.intlib.frontend.data.pipeline.PipelineConnection;
