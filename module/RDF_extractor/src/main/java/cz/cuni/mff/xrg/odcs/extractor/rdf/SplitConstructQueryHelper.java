...
public class SplitConstructQueryHelper {
	 ...
	 *
	 * @param constructQuery SPARQL construct query you could be split.
	 * @param splitSize      Maximum count of RDF triples as construct query
	 *                       restriction
	 */
	 ...
	 *         OFFSET clauses.
	 *
	 * @throws InvalidQueryException if the given construct query contains some
