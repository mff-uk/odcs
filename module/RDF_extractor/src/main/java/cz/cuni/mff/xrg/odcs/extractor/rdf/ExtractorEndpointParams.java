...
public final class ExtractorEndpointParams {
	 ...
	 * @param namedGraphParam   String value of named graph parameter.
	 * @param requestType       HTTP request type for SPARQL extractor.
	 */
	 ...
	 * @param defaultGraphParam String value of default graph parameter.
	 * @param namedGraphParam   String value of named graph parameter.
	 * @param defaultGraphURI   Collection of default graphs used for
	 *                          extraction.
	 * @param namedGraphURI     Collection of named graphs used for extraction.
	 * @param requestType       HTTP request type for SPARQL extractor.
	 */
	 ...
	 *
	 * @param graphURI String value of default graph URI.
	 */
	 ...
	 *
	 * @param graphURI String value of named graph URI.
	 */
