...
public class SilkLinkerConfig extends DPUConfigObjectBase {
	 ...
	 * @param confFileLabel   Label for the configuration file from which the
	 *                        configuration was created
	 * @param minConfirmed    Minimum score for the links to be considered as
	 *                        confirmed
	 * @param minToBeVerified Minimum score for the links to be considered as
	 *                        "to be verified"
	 */
