 ...
 *
 * @param <SerializationInputType>  type of the input data, of the individual record, which will be
 *                                  serialized
 * @param <SerializationOutputType> type of the output data, the result of serialization
 * @param <RepositoryStoreType>     type of the data pushed to the repository
 */
