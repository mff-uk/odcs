...
public enum Currency {
    CZK("CZK", "Kč"), EUR("EUR", "€"), SKK("SKK", "Sk"), USD("USD", "$"), UNDEFINED("undefined", "undefined");
    ...
    /**
     * Parse given string as currency (code, sign, ...) and return the enum value which corresponds to it.
     * 
     * @param currency
