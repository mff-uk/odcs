...
public class DataUnitList<T extends DataUnit> {
	...
	/**
	 * Create instance of {@link DataUnitList} for working with DataUnits
	 * that are stored in given context.
	 * @param context
	 * @return
	 */	
	...
	/**
	 * Return {@link DataUnitList} with the DataUnits of given type
	 * that are in current instance.
	 * of given class.
	...
	/**
	 * Return first DataUnit, if there is no such 
	 * DataUnit throw exception.
