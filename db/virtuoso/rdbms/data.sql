...
INSERT INTO DB.INTLIB.DPU_TEMPLATE(id,name,description,type,jar_path,visibility,jar_description) VALUES(2,'RDF File Extractor','Extracts RDF data from a file.',0,'FileExtractor-0.0.1.jar',1,'No description in manifest.');
