...
INSERT INTO DB.ODCS.DPU_INSTANCE(id,name,use_dpu_description,description,tool_tip,configuration,dpu_id) VALUES(1,'SPARQL Extractor',1,'Extract from SPARQL: http://dbpedia.org/sparql',N'',N'<object-stream> <cz.cuni.mff.xrg.odcs.extractor.rdf.RDFExtractorConfig> <SPARQL__endpoint>http://dbpedia.org/sparql</SPARQL__endpoint> <Host__name></Host__name> <Password></Password> <GraphsUri class="linked-list"> <string>http://dbpedia.org</string> </GraphsUri> <SPARQL__query>CONSTRUCT {&lt;http://dbpedia.org/resource/Prague&gt; ?p ?o} where {&lt;http://dbpedia.org/resource/Prague&gt; ?p ?o } LIMIT 100</SPARQL__query> <ExtractFail>true</ExtractFail> <UseStatisticalHandler>false</UseStatisticalHandler> </cz.cuni.mff.xrg.odcs.extractor.rdf.RDFExtractorConfig> </object-stream>',1);

INSERT INTO DB.ODCS.DPU_INSTANCE(id,name,use_dpu_description,description,tool_tip,configuration,dpu_id) VALUES(2,'RDF File Loader',1,'Load to: /tmp/dbpedia.rdf',N'',N'<object-stream> <cz.cuni.mff.xrg.odcs.loader.file.FileLoaderConfig> <FilePath>/tmp/dbpedia.rdf</FilePath> <RDFFileFormat>RDFXML</RDFFileFormat> <DiffName>false</DiffName> </cz.cuni.mff.xrg.odcs.loader.file.FileLoaderConfig> </object-stream>',5);


-- Table DB.ODCS.DPU_INSTANCE 2 rows output.
-- SELECT * FROM DB.ODCS.DPU_TEMPLATE
INSERT INTO DB.ODCS.DPU_TEMPLATE(id,name,use_dpu_description,description,configuration,parent_id,user_id,visibility,type,jar_directory,jar_name,jar_description) VALUES(1,'SPARQL Extractor',0,N'--null--',N'<object-stream> <cz.cuni.mff.xrg.odcs.extractor.rdf.RDFExtractorConfig> <SPARQL__endpoint></SPARQL__endpoint> <Host__name></Host__name> <Password></Password> <GraphsUri class="linked-list"> <string></string> </GraphsUri> <SPARQL__query></SPARQL__query> <ExtractFail>true</ExtractFail> <UseStatisticalHandler>true</UseStatisticalHandler> <retrySize>-1</retrySize> <retryTime>1000</retryTime> </cz.cuni.mff.xrg.odcs.extractor.rdf.RDFExtractorConfig> </object-stream>',NULL,1,1,0,'SPARQL_Extractor','SPARQL_Extractor-1.0.0.jar','Extracts RDF data from SPARQL.');

INSERT INTO DB.ODCS.DPU_TEMPLATE(id,name,use_dpu_description,description,configuration,parent_id,user_id,visibility,type,jar_directory,jar_name,jar_description) VALUES(2,'RDF File Extractor',0,N'--null--',N'<object-stream> <cz.cuni.mff.xrg.odcs.extractor.file.FileExtractorConfig> <Path></Path> <FileSuffix></FileSuffix> <RDFFormatValue>AUTO</RDFFormatValue> <fileExtractType>PATH_TO_FILE</fileExtractType> <OnlyThisSuffix>false</OnlyThisSuffix> <UseStatisticalHandler>true</UseStatisticalHandler> </cz.cuni.mff.xrg.odcs.extractor.file.FileExtractorConfig> </object-stream>',NULL,1,1,0,'RDF_File_Extractor','RDF_File_Extractor-1.0.0.jar','Extracts RDF data from a file.');

INSERT INTO DB.ODCS.DPU_TEMPLATE(id,name,use_dpu_description,description,configuration,parent_id,user_id,visibility,type,jar_directory,jar_name,jar_description) VALUES(3,'SPARQL Transformer',0,N'--null--',N'<object-stream> <cz.cuni.mff.xrg.odcs.transformer.SPARQL.SPARQLTransformerConfig> <SPARQL__Update__Query></SPARQL__Update__Query> <isConstructType>false</isConstructType> </cz.cuni.mff.xrg.odcs.transformer.SPARQL.SPARQLTransformerConfig> </object-stream>',NULL,1,1,1,'SPARQL_Transformer','SPARQL_Transformer-1.0.0.jar','SPARQL Transformer.');

INSERT INTO DB.ODCS.DPU_TEMPLATE(id,name,use_dpu_description,description,configuration,parent_id,user_id,visibility,type,jar_directory,jar_name,jar_description) VALUES(4,'SPARQL Loader',0,N'--null--',N'<object-stream> <cz.cuni.mff.xrg.odcs.loader.rdf.RDFLoaderConfig> <SPARQL__endpoint></SPARQL__endpoint> <Host__name></Host__name> <Password></Password> <GraphsUri class="linked-list"> <string></string> </GraphsUri> <graphOption>OVERRIDE</graphOption> <insertOption>STOP_WHEN_BAD_PART</insertOption> <chunkSize>100</chunkSize> <validDataBefore>false</validDataBefore> <retrySize>-1</retrySize> <retryTime>1000</retryTime> </cz.cuni.mff.xrg.odcs.loader.rdf.RDFLoaderConfig> </object-stream>',NULL,1,1,2,'SPARQL_Loader','SPARQL_Loader-1.0.0.jar','Loads RDF data to SPARQL endpoint.');

INSERT INTO DB.ODCS.DPU_TEMPLATE(id,name,use_dpu_description,description,configuration,parent_id,user_id,visibility,type,jar_directory,jar_name,jar_description) VALUES(5,'RDF File Loader',0,N'--null--',N'<object-stream> <cz.cuni.mff.xrg.odcs.loader.file.FileLoaderConfig> <FilePath></FilePath> <RDFFileFormat>AUTO</RDFFileFormat> <DiffName>false</DiffName> <validDataBefore>false</validDataBefore> </cz.cuni.mff.xrg.odcs.loader.file.FileLoaderConfig> </object-stream>',NULL,1,1,2,'RDF_File_Loader','RDF_File_Loader-1.0.0.jar','Loads RDF data into file.');

INSERT INTO DB.ODCS.DPU_TEMPLATE(id,name,use_dpu_description,description,configuration,parent_id,user_id,visibility,type,jar_directory,jar_name,jar_description) VALUES(6,'RDF Data Validator',0,N'--null--',N'<object-stream> <cz.cuni.mff.xrg.odcs.rdf.validator.RDFDataValidatorConfig> <stopExecution>false</stopExecution> <sometimesOutput>true</sometimesOutput> </cz.cuni.mff.xrg.odcs.rdf.validator.RDFDataValidatorConfig> </object-stream>',NULL,1,1,1,'RDF_Data_Validator','RDF_Data_Validator-1.0.0.jar','Validate RDF data and create validation report.');
