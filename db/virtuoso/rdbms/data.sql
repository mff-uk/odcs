...
INSERT INTO DB.INTLIB.DPU_TEMPLATE(id,name,use_dpu_description,description,type,jar_directory,jar_name,configuration,parent_id,user_id,visibility,jar_description) VALUES(1,'SPARQL Extractor',0,'Extracts RDF data.',0,'','RDF_extractor-0.0.1.jar','',NULL,1,1,'No description in manifest.');
INSERT INTO DB.INTLIB.DPU_TEMPLATE(id,name,use_dpu_description,description,type,jar_directory,jar_name,configuration,parent_id,user_id,visibility,jar_description) VALUES(2,'RDF File Extractor',0,'Extracts RDF data from a file.',0,'','File_extractor-0.0.1.jar','',NULL,1,1,'No description in manifest.');
INSERT INTO DB.INTLIB.DPU_TEMPLATE(id,name,use_dpu_description,description,type,jar_directory,jar_name,configuration,parent_id,user_id,visibility,jar_description) VALUES(3,'SPARQL Transformer',0,'SPARQL Transformer.',1,'','SPARQL_transformer-0.0.1.jar','',NULL,1,1,'No description in manifest.');
INSERT INTO DB.INTLIB.DPU_TEMPLATE(id,name,use_dpu_description,description,type,jar_directory,jar_name,configuration,parent_id,user_id,visibility,jar_description) VALUES(4,'SPARQL Loader',0,'Loads RDF data.',2,'','RDF_loader-0.0.1.jar','',NULL,1,1,'No description in manifest.');
INSERT INTO DB.INTLIB.DPU_TEMPLATE(id,name,use_dpu_description,description,type,jar_directory,jar_name,configuration,parent_id,user_id,visibility,jar_description) VALUES(5,'RDF File Loader',0,'Loads RDF data into file.',2,'','File_loader-0.0.1.jar','',NULL,1,1,'No description in manifest.');
