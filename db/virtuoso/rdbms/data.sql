...
FOREACH HEXADECIMAL BLOB INSERT INTO DB.INTLIB.DPU_INSTANCE(id,name,use_dpu_description,description,tool_tip,configuration,dpu_id) VALUES(1,'SPARQL Extractor',0,'','',?,1);
...
END
FOREACH HEXADECIMAL BLOB INSERT INTO DB.INTLIB.DPU_INSTANCE(id,name,use_dpu_description,description,tool_tip,configuration,dpu_id) VALUES(2,'RDF File Loader',0,'','',?,5);
3C6F626A6563742D73747265616D3E0A20203C637A2E63756E692E6D66662E78
...
FOREACH HEXADECIMAL BLOB INSERT INTO DB.INTLIB.DPU_TEMPLATE(id,name,use_dpu_description,description,configuration,parent_id,user_id,visibility,type,jar_directory,jar_name,jar_description) VALUES(1,'SPARQL Extractor',0,'',?,NULL,1,1,0,'RDF_extractor','RDF_extractor-1.0.0.jar','Extracts RDF data.');

...
6C654C6F61646572436F6E6669673E0A3C2F6F626A6563742D73747265616D3E
END
FOREACH HEXADECIMAL BLOB INSERT INTO DB.INTLIB.DPU_TEMPLATE(id,name,use_dpu_description,description,configuration,parent_id,user_id,visibility,type,jar_directory,jar_name,jar_description) VALUES(2,'RDF File Extractor',0,'',?,NULL,1,1,0,'File_extractor','File_extractor-1.0.0.jar','Extracts RDF data from a file.');

...
6C654C6F61646572436F6E6669673E0A3C2F6F626A6563742D73747265616D3E
END
FOREACH HEXADECIMAL BLOB INSERT INTO DB.INTLIB.DPU_TEMPLATE(id,name,use_dpu_description,description,configuration,parent_id,user_id,visibility,type,jar_directory,jar_name,jar_description) VALUES(3,'SPARQL Transformer',0,'',?,NULL,1,1,1,'SPARQL_transformer','SPARQL_transformer-1.0.0.jar','SPARQL Transformer.');

...
6C654C6F61646572436F6E6669673E0A3C2F6F626A6563742D73747265616D3E
END
FOREACH HEXADECIMAL BLOB INSERT INTO DB.INTLIB.DPU_TEMPLATE(id,name,use_dpu_description,description,configuration,parent_id,user_id,visibility,type,jar_directory,jar_name,jar_description) VALUES(4,'SPARQL Loader',0,'',?,NULL,1,1,2,'RDF_loader','RDF_loader-1.0.0.jar','Loads RDF data.');

...
6C654C6F61646572436F6E6669673E0A3C2F6F626A6563742D73747265616D3E
END
FOREACH HEXADECIMAL BLOB INSERT INTO DB.INTLIB.DPU_TEMPLATE(id,name,use_dpu_description,description,configuration,parent_id,user_id,visibility,type,jar_directory,jar_name,jar_description) VALUES(5,'RDF File Loader',0,'',?,NULL,1,1,2,'File_loader','File_loader-1.0.0.jar','Loads RDF data into file.');

...
-- SELECT * FROM DB.INTLIB.PPL_PPL_CONFLICTS
-- Table DB.INTLIB.PPL_PPL_CONFLICTS 0 rows output.
-- SELECT * FROM DB.INTLIB.RDF_PREFIX
-- Table DB.INTLIB.RDF_PREFIX 0 rows output.
