...
INSERT INTO DB.ODCS.DPU_TEMPLATE(id,name,use_dpu_description,description,configuration,parent_id,user_id,visibility,type,jar_directory,jar_name,jar_description) VALUES(1,N'SPARQL Extractor',0,N'--null--',N'<object-stream> <cz.cuni.mff.xrg.odcs.extractor.rdf.RDFExtractorConfig> <SPARQL__endpoint></SPARQL__endpoint> <Host__name></Host__name> <Password></Password> <GraphsUri class="linked-list"> <string></string> </GraphsUri> <SPARQL__query></SPARQL__query> <ExtractFail>true</ExtractFail> <UseStatisticalHandler>true</UseStatisticalHandler> <retrySize>-1</retrySize> <retryTime>1000</retryTime> </cz.cuni.mff.xrg.odcs.extractor.rdf.RDFExtractorConfig> </object-stream>',NULL,1,1,0,N'SPARQL_Extractor',N'SPARQL_Extractor-1.0.0.jar',N'Extracts RDF data from SPARQL.');

INSERT INTO DB.ODCS.DPU_TEMPLATE(id,name,use_dpu_description,description,configuration,parent_id,user_id,visibility,type,jar_directory,jar_name,jar_description) VALUES(2,N'RDF File Extractor',0,N'--null--',N'<object-stream> <cz.cuni.mff.xrg.odcs.extractor.file.FileExtractorConfig> <Path></Path> <FileSuffix></FileSuffix> <RDFFormatValue>AUTO</RDFFormatValue> <fileExtractType>PATH_TO_FILE</fileExtractType> <OnlyThisSuffix>false</OnlyThisSuffix> <UseStatisticalHandler>true</UseStatisticalHandler> </cz.cuni.mff.xrg.odcs.extractor.file.FileExtractorConfig> </object-stream>',NULL,1,1,0,N'RDF_File_Extractor',N'RDF_File_Extractor-1.0.0.jar',N'Extracts RDF data from a file.');

INSERT INTO DB.ODCS.DPU_TEMPLATE(id,name,use_dpu_description,description,configuration,parent_id,user_id,visibility,type,jar_directory,jar_name,jar_description) VALUES(3,N'SPARQL Transformer',0,N'--null--',N'<object-stream> <cz.cuni.mff.xrg.odcs.transformer.SPARQL.SPARQLTransformerConfig> <SPARQL__Update__Query></SPARQL__Update__Query> <isConstructType>false</isConstructType> </cz.cuni.mff.xrg.odcs.transformer.SPARQL.SPARQLTransformerConfig> </object-stream>',NULL,1,1,1,N'SPARQL_Transformer',N'SPARQL_Transformer-1.0.0.jar',N'SPARQL Transformer.');

INSERT INTO DB.ODCS.DPU_TEMPLATE(id,name,use_dpu_description,description,configuration,parent_id,user_id,visibility,type,jar_directory,jar_name,jar_description) VALUES(4,N'SPARQL Loader',0,N'--null--',N'<object-stream> <cz.cuni.mff.xrg.odcs.loader.rdf.RDFLoaderConfig> <SPARQL__endpoint></SPARQL__endpoint> <Host__name></Host__name> <Password></Password> <GraphsUri class="linked-list"> <string></string> </GraphsUri> <graphOption>OVERRIDE</graphOption> <insertOption>STOP_WHEN_BAD_PART</insertOption> <chunkSize>100</chunkSize> <validDataBefore>false</validDataBefore> <retrySize>-1</retrySize> <retryTime>1000</retryTime> </cz.cuni.mff.xrg.odcs.loader.rdf.RDFLoaderConfig> </object-stream>',NULL,1,1,2,N'SPARQL_Loader',N'SPARQL_Loader-1.0.0.jar',N'Loads RDF data to SPARQL endpoint.');

INSERT INTO DB.ODCS.DPU_TEMPLATE(id,name,use_dpu_description,description,configuration,parent_id,user_id,visibility,type,jar_directory,jar_name,jar_description) VALUES(5,N'RDF File Loader',0,N'--null--',N'<object-stream> <cz.cuni.mff.xrg.odcs.loader.file.FileLoaderConfig> <FilePath></FilePath> <RDFFileFormat>AUTO</RDFFileFormat> <DiffName>false</DiffName> <validDataBefore>false</validDataBefore> </cz.cuni.mff.xrg.odcs.loader.file.FileLoaderConfig> </object-stream>',NULL,1,1,2,N'RDF_File_Loader',N'RDF_File_Loader-1.0.0.jar',N'Loads RDF data into file.');

INSERT INTO DB.ODCS.DPU_TEMPLATE(id,name,use_dpu_description,description,configuration,parent_id,user_id,visibility,type,jar_directory,jar_name,jar_description) VALUES(6,N'RDF Data Validator',0,N'--null--',N'<object-stream> <cz.cuni.mff.xrg.odcs.rdf.validator.RDFDataValidatorConfig> <stopExecution>false</stopExecution> <sometimesOutput>true</sometimesOutput> </cz.cuni.mff.xrg.odcs.rdf.validator.RDFDataValidatorConfig> </object-stream>',NULL,1,1,1,N'RDF_Data_Validator',N'RDF_Data_Validator-1.0.0.jar',N'Validate RDF data and create validation report.');
