...
DROP TABLE "DB"."INTLIB"."SCH_NOTIFICATION_EMAIL";
DROP TABLE "DB"."INTLIB"."SCH_NOTIFICATION";
...
CREATE TABLE "DB"."INTLIB"."SCH_NOTIFICATION"
(
  "id" INTEGER IDENTITY,
  "schedule_id" INTEGER,
...
CREATE TABLE "DB"."INTLIB"."SCH_NOTIFICATION_EMAIL"
(
...
-- Table "DB"."INTLIB"."SCH_NOTIFICATION"
ALTER TABLE "DB"."INTLIB"."SCH_NOTIFICATION"
  ADD CONSTRAINT "SCH_NOTIFICATION_EXEC_SCHEDULE_id_id" FOREIGN KEY ("schedule_id")
    REFERENCES "DB"."INTLIB"."EXEC_SCHEDULE" ("id")
	ON UPDATE CASCADE ON DELETE CASCADE;


-- Table "DB"."INTLIB"."SCH_NOTIFICATION_EMAIL"
ALTER TABLE "DB"."INTLIB"."SCH_NOTIFICATION_EMAIL"
  ADD CONSTRAINT "SCH_NOTIFICATION_EMAIL_SCH_NOTIFICATION_id_id" FOREIGN KEY ("email_id")
    REFERENCES "DB"."INTLIB"."SCH_NOTIFICATION" ("id")
	ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE "DB"."INTLIB"."SCH_NOTIFICATION_EMAIL"
  ADD CONSTRAINT "SCH_NOTIFICATION_EMAIL_SCH_EMAIL_id_id" FOREIGN KEY ("email_id")
